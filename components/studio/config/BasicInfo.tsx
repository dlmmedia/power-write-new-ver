  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-400">Essential details about your book</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <select
            ...
            className="w-full bg-gray-900 border border-gray-700 rounded px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-yellow-500"
          >
        ...
        <div className="border-t border-gray-800 pt-4 mt-6">
          <h3 className="text-lg font-semibold mb-3">Series Information (Optional)</h3>
        ...
        {/* Co-Authors */}
        <div className="border-t border-gray-800 pt-4 mt-6">
          <h3 className="text-lg font-semibold mb-3">Co-Authors (Optional)</h3>
          <Input
