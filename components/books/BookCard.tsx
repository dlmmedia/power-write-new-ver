...
export const BookCard: React.FC<BookCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full aspect-[2/3] overflow-hidden rounded-lg mb-3 bg-gray-900">
        {hasImage ? (
          <>
            {/* Loading placeholder */}
            {!imageLoaded && (
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-gray-800 border-2 border-yellow-400/20">
            <div className="text-5xl mb-2">📖</div>
            <div className="text-xs text-gray-500 font-medium">No Cover</div>
          </div>
        )}
      ...
      <div className="space-y-1">
        <h3 className="font-semibold text-sm text-white group-hover:text-yellow-400 transition-colors line-clamp-2 leading-tight">
          {book.title}
        </h3>
