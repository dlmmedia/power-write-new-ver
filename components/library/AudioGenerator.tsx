  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gray-900 rounded-lg border border-gray-800 p-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            ...
            <div className="text-sm text-gray-400">Generate complete audiobook</div>
          </button>
          <button
          ...
          >
            ...
            <div className="text-sm text-gray-400">Choose specific chapters</div>
          </button>
        </div>
      </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <div className="text-xs text-gray-400">Faster, lower cost</div>
            </button>
            <button
            ...
            >
              ...
              <div className="text-xs text-gray-400">Higher quality</div>
            </button>
          </div>
        </div>
      </div>
        ...
        <div className="bg-gray-900 rounded-lg border border-gray-800 p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-400">Your complete audiobook has been generated</p>
            </div>
      ...
      {generatedAudios.length > 0 && (
        <div className="bg-gray-900 rounded-lg border border-gray-800 p-6">
          <h4 className="font-semibold mb-4">Generated Chapter Audio</h4>
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      ...
                      <p className="text-xs text-gray-400">~{audio.duration} seconds</p>
                    </div>
